...
public class ManualTransactionExceptionHandler {
    ...
    public ProblemDetail handleManualTransactionNotFoundException(ManualTransactionNotFoundException e) {
    ...
    public ProblemDetail handleManualTransactionOwnershipException(ManualTransactionOwnershipException e) {
        logger.error(e.getMessage());
