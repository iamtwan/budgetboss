...
const SignUpNav = () => {
    ...
    return (
        <div>
            <a type='button' className='btn-sm p-2 fw-semibold nav-text link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover' onClick={handleShow}>Sign Up</a>
