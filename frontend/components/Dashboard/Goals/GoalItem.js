...
const GoalItem = ({ goal, onDelete, onEdit }) => {
    ...
    return (
        <div>
            ...
            <div className='form-text text-start fst-italic mt-0 ms-2'>
                Currently saved {calculation.percent}% {calculation.percent < 20 ? `($${roundedSavedAmount})` : ''} of the ${roundedTargetAmount} goal
            </div>
        </div >
    );
}
